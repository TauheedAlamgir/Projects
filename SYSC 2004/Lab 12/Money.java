...
public class Money implements Comparable
{
    ...
    public Money addMonies (int number, int cents, Object obj) throws Exception
    {
        ...
        if((number < 1) || (number > 10)) {
            throw new IllegalArgumentException ("Any number that is not between 1 and 10");
        }
        if((cents < 0) || (cents > 99)) {
            throw new IllegalArgumentException ("Any Cents number that is not between 0 and 99");
        }
        if(obj == null) {
            throw new NullPointerException ("obj currently is 0");
        }
        if(obj instanceof Money == false) {
            throw new ClassCastException ("obj currently is not part of Object Money");
        }
